export default {
  ...
  'formandstep-form.getparam.input.option': 'Please enter the options',
  'formandstep-form.getparam.finishStep1': 'Next',
  'formandstep-form.getparam.finishAllSteps': 'Submit',
  'formandstep-form.getparam.step2.laststep': 'Back',
  'formandstep-form.getparam.step3.again': 'Try again',
  'formandstep-form.getparam.step3.backToList': 'Back to list',
  'formandstep-form.getparam.step3.completed': 'Completed',
  ...
  'formandstep-form.getparam.rotation.title':
    'Enter the option codes for each parameter (1,2,3,...), then click Submit.',
};
