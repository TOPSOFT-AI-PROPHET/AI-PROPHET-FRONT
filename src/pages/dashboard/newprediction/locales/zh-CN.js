export default {
  ...
  'formandstep-form.getparam.input.option': '请输入选项',
  'formandstep-form.getparam.finishStep1': '下一步',
  'formandstep-form.getparam.finishAllSteps': '提交',
  'formandstep-form.getparam.step2.laststep': '上一步',
  'formandstep-form.getparam.step3.again': '再测一次',
  'formandstep-form.getparam.step3.backToList': '返回列表',
  'formandstep-form.getparam.step3.completed': '提交成功',
